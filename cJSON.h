...
// @return Ponteiro para string recém-alocada (use cJSON_free para liberar).

CJSON_PUBLIC(char *) cJSON_Print(const cJSON *item);


// @brief Analisa uma string JSON e retorna a árvore cJSON.
// @param value String JSON de entrada.
